<?php
    ...
    $sql = "SELECT memberid, name, gender, dob, TIMESTAMPDIFF(YEAR, dob, CURDATE()) AS my_age, mobileno, address, photo, active FROM member WHERE MONTH(dob) = $month AND mandal='$mandal' AND active=true ORDER BY DAY(dob)";
