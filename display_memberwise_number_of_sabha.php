...
<head>
    ...
    <title>Member-wise Attendance</title>
...
<body>
    <div class="container bg-light">
        ...
        <div class="row">
            <div class="col-md-12 pt-3">
                <h3 class="text-center"><u>Member-wise Number of Sabha Attended</u></h3>
            </div>
        </div>
        <form method="GET" action="" id="searchByMemberForm">
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    <input type="date" class="form-control" name="startDate" id="startDate" value="<?= $startDate != null ? $startDate : date('Y').'-01-01' ?>" max="<?= date('Y-m-d') ?>" required>
                </div>
