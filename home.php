...
<head>
    ...
    <title>Dindoli Sabha Attendance Management System</title>
    ...
    <div class="container bg-light">
        <div class="row">
            <div class="col-md-12">
	            ...
	            <h3 class="align-center">દાસના દાસ 🙏🏻</h3>
                <hr/>
                <h1 class="align-center">Welcome to Dindoli Sabha Attendance Management System</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <br/>
                <h3 class="align-center"><a href="display_member.php">Check Attendance for Member</a></h3>
            </div>
        </div>
        <!-- <div class="row">
            <br/>
